...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = TIMHelper.sdkAppID;
     ...
     * <p>
     * 时间单位：秒
     * 默认时间：7 x 24 x 60 x 60 = 604800 = 7 天 * 265
     */
    private static final int EXPIRETIME = 7 * 24 * 60 * 60 * 365;
     ...
     */
    private static final String SECRETKEY = TIMHelper.sdkSecret;
